...
# MAGIC %md
# MAGIC TODO: this job is basically identical to mappingtool_datarefresh_mapdef_source, except source/target prefix in filename
...
#debug
# selection_set_filename = 'PN_MULTI_TARGET_I'
# mapping_def_file_name = 'TRMD_2306151513'

# test case for timestamp issue
# mapping_def_file_name = 'MULTI_EDIT_AA'
# selection_set_filename = "dim_type_1"
...
targeturl = f"/mnt/light-refined/mapping-definition/target_{mapping_def_file_name}_{selection_set_filename}.parquet"
print(ssurl)
print(targeturl)
